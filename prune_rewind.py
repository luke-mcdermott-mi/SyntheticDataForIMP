...
if __name__ == '__main__':
    ...
    for p in path_list:
        ...
        save_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_10/convnet-3/untrained_rewind3'
        model_weights_path = save_path + 'trained_epoch3_iter0'
        prune_model(args, train_loader, val_loader, save_path, model_fn=convnet3, max_prune_iters=10, amount=.2)
        
        print('Resnet10 Prune!')
        save_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_10/resnet-10/untrained_rewind5'
        model_weights_path = save_path + 'trained_epoch5_iter0'

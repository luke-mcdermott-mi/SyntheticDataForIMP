...
def IMP(args, logger):
    ...
    if args.model == 'convnet3':
        ...
        if args.dataset == 'cifar10':
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_10/convnet-3/untrained_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_10/convnet-3/'
        elif args.dataset == 'cifar100':
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_100/convnet-3/untrained_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_100/convnet-3/'    
        elif args.dataset == 'imagenet' and args.nclass == 10:
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_10/convnet-3/untrained_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_10/convnet-3/'    
        elif args.dataset == 'imagenet' and args.nclass == 100:
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_100/convnet-3/untrained_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_100/convnet-3/'
    elif args.model == 'resnet10_bn':
        model_fn = resnet10_bn
        if args.dataset == 'cifar10':
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_10/resnet-10/untrained_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_10/resnet-10/'
        elif args.dataset == 'cifar100':
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_100/resnet-10/untrained_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_100/resnet-10/'    
        elif args.dataset == 'imagenet' and args.nclass == 10:
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_10/resnet-10/untrained_10_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_10/resnet-10/'    
        elif args.dataset == 'imagenet' and args.nclass == 100:
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_100/resnet-10/untrained_iter'
        ...
        if args.dataset == 'cifar10':
            ...
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_100/resnet-18/untrained_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/cifar_100/resnet-18/'    
        elif args.dataset == 'imagenet' and args.nclass == 10:
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_10/resnet-18/untrained_10_iter'
            save_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_10/resnet-18/'    
        elif args.dataset == 'imagenet' and args.nclass == 100:
            untrained_path = '/home/ubuntu/luke/LMC/pruned_models/imagenet_100/resnet-18/untrained_iter'
    ...
    model.load_state_dict(torch.load(untrained_path + '4'))
    prune.global_unstructured(get_parameters_to_prune(model),pruning_method=prune.L1Unstructured,amount=0)
    #model.load_state_dict(torch.load(untrained_path + '0'))
    rewind_model = model_fn(args, nclass, logger=logger)
    prune.global_unstructured(get_parameters_to_prune(rewind_model),pruning_method=prune.L1Unstructured,amount=0)
    rewind_model.load_state_dict(torch.load(untrained_path + '4'))
    prune.global_unstructured(get_parameters_to_prune(rewind_model),pruning_method=prune.L1Unstructured,amount=0)
    #rewind_model.load_state_dict(torch.load(untrained_path + '0'))
    ...
    for prune_iter in range(1,11):
        ...
        if not os.path.exists(untrained_path + '_iter'+str(iter) + 'imp'):
            ...
            torch.save(model.state_dict(), 'syn_init_' + untrained_path + str(prune_iter) + '_imp')

            #Train Model !
            best_acc, acc = train(args, model, train_loader, val_loader, plotter, logger)
            torch.save(model.state_dict(), save_path + 'syn_init_trained_imp_iter' + str(prune_iter))

...
parser.add_argument('--imagenet_dir', default='/data/datasets/research-datasets/imagenet/ILSVRC/Data/CLS-LOC/', type=str)
...
parser.add_argument('--device', type=int, default=7, help='gpu id to use')
parser.add_argument('--model', type=str, default='', help='convnet3, resnet10_bn, resnet18_bn')
parser.add_argument('--prune_iter', type=int, default=0, help='which sparsity subnetwork to use')
parser.add_argument('--ipc_path', type=int, default=0, help='which sparsity subnetwork to use')
